    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar className={classes.noSpacing}>
          ...
          <Button color="inherit" className={classes.dashButton} onClick={handleAppt}>Appt</Button>
          <Button color="inherit" className={classes.statButton} onClick={handleVisit}>Visit</Button>
       </Toolbar>
      </AppBar>
      <DisplayCdItems/>
    </div>
