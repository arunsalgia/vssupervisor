...
return (
	<FormControl component="fieldset">
		<RadioGroup row aria-label="rgrp" name="rgrp" value={props.value} key={props.value} onChange={props.onChange}>
	{(_field) &&
	...
	{(!_field) &&
		props.radioList.map ( r =>
		<FormControlLabel className={gClasses.filterRadio} value={r[props.radioField]} key={r[props.radioField]} 
